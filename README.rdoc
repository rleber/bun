...
* Has problems with certain (uncommon) situations where multiple versions of files with weird names create ambiguous
  duplicate file names. These weird situations happen, unfortunately, occur occasionally within the Waterloo Honeywell 
  archives.
