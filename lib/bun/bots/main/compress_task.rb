...
The --aggressive parameter controls what files are flagged as duplicates, and how they are handled. 
With --Aggressive, ALL files with duplicate content are deleted, except for the oldest one, regardless
...
Flag                        Meaning                             Action
--no-aggressive, --no-link  Delete duplicates with identical    Deletes file1/tape.ar002.0002. Creates
                            target paths. Keep all other        the other two files. No symlinks are
                            duplicates. Do not create symlinks  created.
                            (This is the default.)

--aggressive,    --no-link  Delete all duplicates, even if      Deletes file1/tape.ar002.0002 and 
                            they have different target paths.   file2/tape.ar003.0003. No symlinks
                            Do not create symlinks.             are created.

--no-aggressive, --link     Delete duplicates with identical    Deletes file1/tape.ar002.0002
...
--aggressive,    --link     Delete all duplicates, even if      Deletes file1/tape.ar002.0002 and
